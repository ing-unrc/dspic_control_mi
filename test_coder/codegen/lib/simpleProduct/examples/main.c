...
static void main_simpleProduct(void);
...
static void main_simpleProduct(void)
{
  ...
  /* Initialize function 'simpleProduct' input arguments. */
  /* Call the entry-point 'simpleProduct'. */
  c = simpleProduct(argInit_real32_T(), argInit_real32_T());
}
